...
const TrainerDetailsPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get Trainer Details",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("trainerDetails").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
  ...
  return (
    <div className="mt-5">
        ...
        <div className="col-6 flex justify-content-end">
          <>
            <Button
              ...
              role="trainerDetails-add-button"
            />
            <SplitButton
      ...
      <AreYouSureDialog
        ...
        onYes={() => deleteRow()}
      />
      <TrainerDetailsEditDialogComponent
