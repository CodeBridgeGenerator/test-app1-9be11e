...
const TrainerDetailsDataTable = ({
  ...
  return (
    <>
      ...
      >
        <Column
          field="trainerIcNumber"
          header="Trainer IC Number"
          body={pTemplate0}
          filter={selectedFilterFields.includes("trainerIcNumber")}
          hidden={selectedHideFields?.includes("trainerIcNumber")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
