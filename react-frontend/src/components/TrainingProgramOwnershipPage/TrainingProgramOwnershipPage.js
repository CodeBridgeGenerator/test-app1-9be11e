...
const TrainingProgramOwnershipPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get Training Program Ownership",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("trainingProgramOwnership").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
    ...
    <div className="mt-5">
        ...
        <div className="col-6 flex justify-content-end">
          <>
            <Button
              ...
              role="trainingProgramOwnership-add-button"
            />
            <SplitButton
      ...
      <div className="grid align-items-center">
        <div className="col-12" role="trainingProgramOwnership-datatable">
          <TrainingProgramOwnershipDatatable
            items={data}
            fields={fields}
      ...
      <AreYouSureDialog
        ...
        onYes={() => deleteRow()}
      />
      <TrainingProgramOwnershipEditDialogComponent
