...
const BusinessInformationPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get Business Information",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("businessInformation").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
  ...
  return (
    <div className="mt-5">
        ...
        <div className="col-6 flex justify-content-end">
          <>
            <Button
              ...
              role="businessInformation-add-button"
            />
            <SplitButton
      ...
      <AreYouSureDialog
        ...
        onYes={() => deleteRow()}
      />
      <BusinessInformationEditDialogComponent
