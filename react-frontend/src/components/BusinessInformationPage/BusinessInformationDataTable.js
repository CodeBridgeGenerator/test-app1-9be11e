...
const BusinessInformationDataTable = ({
  items,
  fields,
  onEditRow,
  onRowDelete,
  ...
  const p_numberTemplate1 = (rowData, { rowIndex }) => (
    <p>{rowData.numberOfEmployees}</p>
  );
  const p_numberTemplate2 = (rowData, { rowIndex }) => (
    <p>{rowData.fullTimeTrainers}</p>
  );
  const p_numberTemplate3 = (rowData, { rowIndex }) => (
    <p>{rowData.partTimeTrainers}</p>
  );
    ...
    <>
      ...
      >
        ...
        <Column
          ...
          filter={selectedFilterFields.includes("numberOfEmployees")}
          hidden={selectedHideFields?.includes("numberOfEmployees")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          field="fullTimeTrainers"
          header="Full Time Trainers"
          body={p_numberTemplate2}
          filter={selectedFilterFields.includes("fullTimeTrainers")}
          hidden={selectedHideFields?.includes("fullTimeTrainers")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          field="partTimeTrainers"
          header="Part Time Trainers"
          body={p_numberTemplate3}
          filter={selectedFilterFields.includes("partTimeTrainers")}
          hidden={selectedHideFields?.includes("partTimeTrainers")}
          sortable
          style={{ minWidth: "8rem" }}
        />
      ...
      <Dialog
        header="Upload BusinessInformation Data"
        visible={showUpload}
      ...
      <Dialog
        header="Search BusinessInformation"
