...
const TrainingProviderInformationPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get Training Provider Information",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("trainingProviderInformation").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
    ...
    <div className="mt-5">
        ...
        <div className="col-6 flex justify-content-end">
          <>
            <Button
              ...
              role="trainingProviderInformation-add-button"
            />
            <SplitButton
      ...
      <div className="grid align-items-center">
        <div className="col-12" role="trainingProviderInformation-datatable">
          <TrainingProviderInformationDatatable
            items={data}
            fields={fields}
      ...
      <AreYouSureDialog
        ...
        onYes={() => deleteRow()}
      />
      <TrainingProviderInformationEditDialogComponent
      ...
      />
      <TrainingProviderInformationFakerDialogComponent
        show={showFakerDialog}
        onHide={() => setShowFakerDialog(false)}
        onFakerCreateResults={onFakerCreateResults}
      />
      <TrainingProviderInformationSeederDialogComponent
